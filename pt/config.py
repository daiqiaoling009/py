...
#                         help="Cache dir of BERT model.")
#     parser.add_argument("--train_tfrecord_dir", type=str, default='pt/tfrecord/',  # 修改了路径
#                         help="Dir of tfrecord example files.")
#     parser.add_argument("--eval_tfrecord_dir", type=str, default='pt/tfrecord/',    # 修改了路径
#                         help="Dir of tfrecord example files.")
#     parser.add_argument("--output_dir", type=str, default='output/pretrained_bert',# 修改了路径
#                         help='The path where the model checkpoints will be written')
#
#     # 设备配置
#     parser.add_argument('--device', default='cuda', type=str,
#                         help="device type for model training",
#                         choices=['cuda', 'cpu'])
#     parser.add_argument('--device_ids', default='0', type=str,
#                         help="device ids for model training(comma-separated list) when device='cuda', `None` for all gpus")
#
#     # 训练参数
#     parser.add_argument("--train_batch_size", type=int, default=64,   # 增大 batch size
#                         help="Batch size for training per gpu.")
...
#                         help="Whether to early stop when training.")
#     parser.add_argument("--max_steps_without_increase", type=int, default=5000,
#                         help="Number of steps without increase before early stopping.")
#
#     return parser.parse_args()